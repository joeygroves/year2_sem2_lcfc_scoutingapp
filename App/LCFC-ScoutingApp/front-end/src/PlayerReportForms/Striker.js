            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <div class="grid-container">
                    <div class="grid-item">
                        ...
                        <input type = "date" value={this.state.date_played} onChange={e => this.setState({ date_played: e.target.value })} required
                        ></input>

                        <label>Playing Against: </label>
                        <input type="string" value={this.state.club_played} onChange={e => this.setState({ club_played: e.target.value })} required
                        ></input>

                        <br></br>

                        <label>H/T: </label>
                        <input value={this.state.ht_score} onChange={e => this.setState({ ht_score: e.target.value })} required
                        ></input>

                        <label>F/T: </label>
                        <input value={this.state.ft_score} onChange={e => this.setState({ ft_score: e.target.value })} required
                        ></input>
                    ...
                    <div class="grid-item">
                        ...
                        <input type="number" max="10" min="0" value={this.state.running_the_channels} onChange={e => this.setState({ running_the_channels: e.target.value })}></input>
