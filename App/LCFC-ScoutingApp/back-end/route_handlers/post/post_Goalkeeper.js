      ...
      if (err) {
        ...
        connect.connection.query(sql, [values], function (err, result) {
          ...
          if (err) {
            ...
            array_of_percentages = [decision_making_percentage,phsyical_percentage,distribution_percentage,general_percentage,psychological_percentage]
            ...
            worksheet.cell(40,21,40,22, true).number(distribution_possiblepoints);
            worksheet.cell(40,23,40,24, true).number(decision_making_possiblepoints);
            worksheet.cell(40,25,40,26, true).number(physical_possiblepoints);
            worksheet.cell(40,27,40,28, true).number(psychological_possiblepoints);


            worksheet.cell(39,29,39,30, true).string('Overall');
            worksheet.cell(39,31,39,32, true).string('Comments');

            worksheet.cell(40,29,40,30, true).number(decision_making_possiblepoints + physical_possiblepoints + psychological_possiblepoints + general_possiblepoints + distribution_possiblepoints);
            worksheet.cell(40,31,40,32, true).string(notes);
